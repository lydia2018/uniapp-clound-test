...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__B90B138",
    appName: "lydia-vue3-uniapp",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/opendb-contacts/add",
    style: {
      navigationBarTitleText: "\u65B0\u589E"
    }
  },
  {
    path: "pages/opendb-contacts/edit",
    style: {
      navigationBarTitleText: "\u7F16\u8F91"
    }
  },
  {
    path: "pages/opendb-contacts/list",
    style: {
      navigationBarTitleText: "\u5217\u8868"
    }
  },
  {
    path: "pages/opendb-contacts/detail",
    style: {
...
(() => {
  {
    ...
    let t2 = {};
    if (e2.length === 1)
      t2 = e2[0], en$1 = en$1.init(t2), en$1.isDefault = true;
    else {
    ...
    Object.assign(en$1, { get mixinDatacom() {
      return Xt(en$1);
    } }), Kt(en$1), en$1.addInterceptor = T, en$1.removeInterceptor = v;
  }
})();
var tn = en$1;
