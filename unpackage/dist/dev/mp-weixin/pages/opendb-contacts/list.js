      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: index,
            c: common_vendor.o(($event) => $options.handleItemClick(item._id)),
            d: "2098294e-2-" + i0 + "-" + i1 + "," + ("2098294e-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "2098294e-1-" + i0 + ",2098294e-0"
      } : {}, {
        c: data,
        g: "2098294e-3-" + i0 + ",2098294e-0",
        h: common_vendor.p({
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/lydia-subject/lydia-vue3-uniapp/pages/opendb-contacts/list.vue"]]);
